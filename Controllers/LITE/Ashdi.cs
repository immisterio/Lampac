...
namespace Lampac.Controllers.LITE
{
    public class Ashdi : BaseController
    {
        ...
        async static ValueTask<string> embed(IMemoryCache memoryCache, long kinopoisk_id)
        {
            ...
            {
                string product = await HttpClient.Get($"{AppInit.conf.Ashdi.host}/api/product/read_api.php?kinopoisk={kinopoisk_id}", useproxy: AppInit.conf.Ashdi.useproxy);
                ...
                content = await HttpClient.Get(iframeuri, useproxy: AppInit.conf.Ashdi.useproxy);
