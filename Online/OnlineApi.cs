            ...
            void send(string name, BaseSettings init, string plugin = null, string arg_title = null, string arg_url = null, string rch_access = null)
            {
                ...
                if (enable)
                {
                    ...
                    if (original_language != null && original_language.Split("|")[0] is "ru" or "ja" or "ko" or "zh" or "cn")
                    {
                        ...
                        if (_p is "filmix" or "filmixtv" or "fxapi" or "rc/filmix" or "kinoukr" or "rezka" or "rhsprem" or "rc/rhs" or "redheadsound" or "kinopub" or "rc/kinopub" or "alloha" or "lumex" or "vcdn" or "fancdn" or "redheadsound" or "kinotochka" or "remux" || (_p == "kodik" && kinopoisk_id == 0 && string.IsNullOrEmpty(imdb_id)))
