...
namespace Online.Controllers
{
    public class RgShows : BaseENGController
    {
        ...
        {
            return ViewTmdb(AppInit.conf.Rgshows, checksearch, id, imdb_id, title, original_title, serial, s, rjson, mp4: true, method: "call", hls_manifest_timeout: (int)TimeSpan.FromSeconds(30).TotalMilliseconds);
        }
