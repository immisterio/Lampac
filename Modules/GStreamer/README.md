...
| `pipeline_audioQueue` | `3` | Максимальный размер очереди аудио в МБ. |
| `pipeline_videoQueue` | `24` | Максимальный размер входной и видеоочереди в МБ. |
| `pipeline_sinkQueue` | `32` | Максимальный размер очереди готовых данных в `appsink`, МБ. |
