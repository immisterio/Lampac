...
namespace Shared.Model
{
    public class AppInit
    {
        ...
        /// </summary>
        public LumexSettings Lumex { get; set; } = new LumexSettings("kwwsv=22sruwdo1oxph{1krvw", "F:]{GKxq7f9PGpQQ|lyGxOgYTSXnMK:l", "oxph{1sz", "tl6h28Hn1rL5") { enable = true, scheme = "http", geostreamproxy = new List<string>() { "ALL" } };
