    ...
    public class AppInit : Shared.Model.AppInit
    {
        ...
        { 
            ...
            cover = new CoverSettings() 
            {
                ...
                previewComand = "-n -ss 00:03:00 -to 00:03:07 -i \"{file}\" -ss 00:04:37 -to 00:04:44 -i \"{file}\" -ss 00:06:41 -to 00:06:48 -i \"{file}\" -ss 00:09:20 -to 00:09:27 -i \"{file}\" -ss 00:12:45 -to 00:12:52 -i \"{file}\" -ss 00:17:09 -to 00:17:16 -i \"{file}\" -ss 00:22:50 -to 00:22:57 -i \"{file}\" -ss 00:29:51 -to 00:29:58 -i \"{file}\" -ss 00:39:23 -to 00:39:30 -i \"{file}\" -ss 00:51:44 -to 00:51:51 -i \"{file}\" -ss 01:07:45 -to 01:07:52 -i \"{file}\" -ss 01:20:33 -to 01:20:40 -i \"{file}\" -filter_complex \"[0:v]setpts=0.5*PTS,scale=-2:360[v0];[1:v]setpts=0.5*PTS,scale=-2:360[v1];[2:v]setpts=0.5*PTS,scale=-2:360[v2];[3:v]setpts=0.5*PTS,scale=-2:360[v3];[4:v]setpts=0.5*PTS,scale=-2:360[v4];[5:v]setpts=0.5*PTS,scale=-2:360[v5];[6:v]setpts=0.5*PTS,scale=-2:360[v6];[7:v]setpts=0.5*PTS,scale=-2:360[v7];[8:v]setpts=0.5*PTS,scale=-2:360[v8];[9:v]setpts=0.5*PTS,scale=-2:360[v9];[10:v]setpts=0.5*PTS,scale=-2:360[v10];[11:v]setpts=0.5*PTS,scale=-2:360[v11];[v0][v1][v2][v3][v4][v5][v6][v7][v8][v9][v10][v11]concat=n=12:v=1:a=0\" -an -r 20 -c:v libx264 -crf 28 -preset veryslow \"{preview}\""
            }
        };
