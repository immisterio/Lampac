...
namespace Shared.Models.Online.Settings
{
    ...
    {
        public OnlinesSettings(string plugin, string host, string apihost = null, bool useproxy = false, string token = null, bool enable = true, bool streamproxy = false, bool rip = false, bool forceEncryptToken = false, string rch_access = null)
        {
            this.enable = enable;
            this.plugin = plugin;
